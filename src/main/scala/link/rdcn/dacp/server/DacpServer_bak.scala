...
//import link.rdcn.dacp.optree.{FlowExecutionContext, TransformTree, OperatorRepository}
//import link.rdcn.dacp.received.DataReceiver
//import link.rdcn.dacp.user.{AuthProvider, DataOperationType, KeyUserPrincipal, KeyCredentials}
...
//import link.rdcn.user.{AuthenticationService, UserPrincipal, Credentials}
...
//        override def getTransformTree: String = ticketInfo._2
//
...
//    val operationStr = request.getTransformTree
...
//    val operation = TransformTree.fromJsonString(operationStr, sourceList)
//    val keyPermission: Option[Boolean] = authenticatedUser match {
//      case keyAuthenticatedUser: KeyUserPrincipal => Some(keyAuthenticatedUser.checkPermission())
//      case _ => None
//    }
